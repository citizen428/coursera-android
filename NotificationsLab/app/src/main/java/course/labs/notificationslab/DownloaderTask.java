...
import static course.labs.notificationslab.R.id.text;
		...
		mApplicationContext.sendOrderedBroadcast(new Intent(
				...
				new BroadcastReceiver() {
					...
					public void onReceive(Context context, Intent intent) {
						...
						// TODO: DONE Check whether the result code is not MainActivity.IS_ALIVE

						if (getResultCode() == MainActivity.IS_ALIVE) {

							// TODO: DONE If so, create a PendingIntent using the
							...
							// TODO: DONE Set the notification View's text to
							// reflect whether the download completed
							// successfully
                            mContentView.setString(text, "setText", "Download completed successfully.");


							// TODO: DONE Use the Notification.Builder class to
							...
							// TODO: DONE Send the notification
                            NotificationManager mNotificationManager =
                                    (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
                            mNotificationManager.notify(MY_NOTIFICATION_ID, noti);
